    ...
    <>
      ...
      >
        <div className="flex items-center gap-2">
          <Link
            ...
            className="btn-secondary !min-h-10 !px-4 !py-1.5"
          >
            ← Zurück
          </Link>
          <Link href="/kalender" className="btn-secondary !min-h-10 !px-4 !py-1.5">
            Heute
          </Link>
          <Link
      ...
      <div className="vtm-enter mx-auto max-w-6xl px-8 py-10 lg:px-12">
          ...
          <div className="grid grid-cols-7">
            {cells.map((day, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`min-h-24 border-b border-r border-[var(--hairline)] p-1.5 ${
                    day === null
                ...
                >
                  {day !== null && (
                    <>
                      <div
                        className={`vtm-mono mb-1 inline-flex h-7 w-7 items-center justify-center rounded-md text-xs ${
                          iso === today
                      ...
                      <div className="space-y-1">
                        {dayEvents.map((e) => (
                          <div
                            ...
                            className="truncate rounded border-l-2 border-[var(--accent)] bg-[var(--surface-raised)] px-1.5 py-0.5 text-xs text-[var(--ink)]"
                          >
                            {e.start_time && (
                              <span className="vtm-mono font-medium">
                                {e.start_time}{" "}
                              </span>
                            )}
                            {e.title}
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-2">
          <section>
            <h2 className="vtm-kicker accent-line mb-4">Neuer Termin</h2>
            <form
              ...
              {events.map((e) => (
                ...
                >
                  <div>
                    ...
                    {e.description && (
                      <p className="mt-1 max-w-[60ch] whitespace-pre-wrap text-xs text-[var(--ink)]">
                        {e.description}
                      </p>
                    )}
                  </div>
